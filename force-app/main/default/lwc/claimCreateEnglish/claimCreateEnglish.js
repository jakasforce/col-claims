...
import { OMNIDEF } from './claimCreateEnglish_def.js';
import tmpl from './claimCreateEnglish.html';
import tmpl_nds from './claimCreateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class claimCreateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
