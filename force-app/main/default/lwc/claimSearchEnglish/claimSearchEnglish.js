...
import { OMNIDEF } from './claimSearchEnglish_def.js';
import tmpl from './claimSearchEnglish.html';
import tmpl_nds from './claimSearchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class claimSearchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
