...
import { OMNIDEF } from './sampleTestEnglish_def.js';
import tmpl from './sampleTestEnglish.html';
import tmpl_nds from './sampleTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sampleTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
