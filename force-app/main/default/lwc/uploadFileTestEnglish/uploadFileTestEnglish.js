...
import { OMNIDEF } from './uploadFileTestEnglish_def.js';
import tmpl from './uploadFileTestEnglish.html';
import tmpl_nds from './uploadFileTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class uploadFileTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
