...
import { OMNIDEF } from './uploadShowFileMultiLanguage_def.js';
import tmpl from './uploadShowFileMultiLanguage.html';
import tmpl_nds from './uploadShowFileMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class uploadShowFileMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
