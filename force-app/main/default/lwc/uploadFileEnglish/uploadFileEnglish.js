...
import { OMNIDEF } from './uploadFileEnglish_def.js';
import tmpl from './uploadFileEnglish.html';
import tmpl_nds from './uploadFileEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class uploadFileEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
