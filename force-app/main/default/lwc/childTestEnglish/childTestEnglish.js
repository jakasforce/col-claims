...
import { OMNIDEF } from './childTestEnglish_def.js';
import tmpl from './childTestEnglish.html';
import tmpl_nds from './childTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class childTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
