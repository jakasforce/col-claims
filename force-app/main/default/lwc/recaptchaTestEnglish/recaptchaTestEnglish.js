...
import { OMNIDEF } from './recaptchaTestEnglish_def.js';
import tmpl from './recaptchaTestEnglish.html';
import tmpl_nds from './recaptchaTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class recaptchaTestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
