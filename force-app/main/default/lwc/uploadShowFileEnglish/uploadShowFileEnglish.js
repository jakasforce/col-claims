...
import { OMNIDEF } from './uploadShowFileEnglish_def.js';
import tmpl from './uploadShowFileEnglish.html';
import tmpl_nds from './uploadShowFileEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class uploadShowFileEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
