...
import { OMNIDEF } from './documentsStarServicesOmniEnglish_def.js';
import tmpl from './documentsStarServicesOmniEnglish.html';
import tmpl_nds from './documentsStarServicesOmniEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentsStarServicesOmniEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
