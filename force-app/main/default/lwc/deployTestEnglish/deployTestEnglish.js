...
import { OMNIDEF } from './deployTestEnglish_def.js';
import tmpl from './deployTestEnglish.html';
import tmpl_nds from './deployTestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class deployTestEnglish extends NavigationMixin(OmniscriptHeader) {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
